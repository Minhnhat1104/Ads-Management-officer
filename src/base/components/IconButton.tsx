import { ForwardedRef, forwardRef, ReactChild, ReactFragment, ReactNode, ReactPortal } from 'react';
...
const IconButton = forwardRef(
  (
    ...
    if (tooltip) {
      return (
        <Tooltip title={tooltipProps?.title} arrow placement={tooltipProps?.placement || 'top'} {...tooltipProps}>
          {IconElement}
        </Tooltip>
      );
    }
