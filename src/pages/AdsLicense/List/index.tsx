  ...
  const fields: FieldsData = [
    {
      ...
      keyName: keyNames.KEY_NAME_REQUEST_AD,
      enableSorting: false,
      width: 'auto',
    },
    {
      languageKey: 'Tên công ty',
      keyName: keyNames.KEY_NAME_REQUEST_COMPANY_NAME,
      enableSorting: false,
      width: 'auto',
    },
    {
      languageKey: 'Email',
      keyName: keyNames.KEY_NAME_REQUEST_COMPANY_EMAIL,
      enableSorting: false,
      width: 'auto',
    },
    {
      languageKey: 'SĐT',
      keyName: keyNames.KEY_NAME_REQUEST_COMPANY_PHONE,
      enableSorting: false,
      width: 'auto',
    },
    {
      languageKey: 'Địa chỉ',
      keyName: keyNames.KEY_NAME_REQUEST_COMPANY_ADDRESS,
      enableSorting: false,
      width: 'auto',
    },
    {
      languageKey: 'Ngày bắt đầu hợp đồng',
      keyName: keyNames.KEY_NAME_REQUEST_COMPANY_START_DATE,
      enableSorting: false,
      width: 100,
    },
    {
      languageKey: 'Ngày kết thúc hợp đồng',
      keyName: keyNames.KEY_NAME_REQUEST_COMPANY_END_DATE,
      enableSorting: false,
      width: 100,
    },
    {
      languageKey: 'Trạng thái',
      keyName: keyNames.KEY_NAME_REQUEST_COMPANY_STATUS,
      enableSorting: false,
      width: 100,
    },
  ];
