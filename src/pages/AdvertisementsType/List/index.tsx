...
import { useAdvertisementType } from 'src/hooks/advertisementType/useAdvertisementType';
...
const List = (props: ListProps) => {
  ...
  // call data
  const { data } = useAdvertisementType();
  const { mDelete } = useAdvertisementsTypeMutation();
  ...
  const fields: FieldsData = [
    {
      ...
      keyName: keyNames.KEY_NAME_ADVERTISEMENT_TYPE_NAME,
      enableSorting: false,
      width: 'auto',
    },
    {
      languageKey: '',
      keyName: keyNames.KEY_NAME_ADVERTISEMENT_TYPE_ACTIONS,
      enableSorting: false,
      width: 50,
    },
  ];
